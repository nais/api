...
-- Created instances inherit their pin as status.version, the way the operator records it
-- after its first reconcile, so an update has a current version to validate against. The
-- two fixtures above 2.19 exist so a downgrade can be attempted at all: nothing below
-- 2.19 is selectable any more.
