...
-- status.version is the sole authority for the version. The CR pin never feeds what the
-- API reports, and a version the operator has not recorded is not reported at all.
...
local function unknownVersion(name)
	return string.format('The running version of "%s" is not known yet. Try again shortly.', name)
end
