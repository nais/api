...
SELECT
    team_environments.id, team_environments.team_slug, team_environments.environment, team_environments.slack_alerts_channel, team_environments.gcp_project_id,
