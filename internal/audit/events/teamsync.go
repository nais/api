...
func (t teamSync) Data() any {
	return nil
}

func (t teamSync) Message() string {
	return "Scheduled team for synchronization"
}
...
func (t teamSync) ResourceType() string {
	return string(model.AuditEventResourceTypeTeam)
}
...
func teamSyncFromRow(row *database.AuditEvent) (Event, error) {
	return &teamSync{
		base{
			actor:     row.Actor,
