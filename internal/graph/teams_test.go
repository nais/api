...
func TestMutationResolver_CreateTeam(t *testing.T) {
	...
	t.Run("create team with empty purpose", func(t *testing.T) {
		_, err := graph.
			NewResolver(nil, nil, nil, nil, nil, db, tenantDomain, usersyncTrigger, auditlogger.NewAuditLoggerForTesting(), nil, nil, log, nil, nil, nil, nil, nil, nil, nil, auditer).
			Mutation().
	...
	t.Run("create team", func(t *testing.T) {
		...
		returnedTeam, err := graph.
			NewResolver(nil, nil, nil, nil, nil, db, tenantDomain, usersyncTrigger, auditLogger, nil, psClient.Topic("topic-id"), log, nil, nil, nil, nil, nil, nil, nil, auditer).
			Mutation().
			CreateTeam(ctx, model.CreateTeamInput{
				Slug:         teamSlug,
...
func TestMutationResolver_RequestTeamDeletion(t *testing.T) {
	...
	t.Run("missing authz", func(t *testing.T) {
		...
		resolver := graph.
			NewResolver(nil, nil, nil, nil, nil, db, tenantDomain, usersyncTrigger, auditlogger.NewAuditLoggerForTesting(), nil, nil, log, nil, nil, nil, nil, nil, nil, nil, nil).
			Mutation()
	...
	t.Run("create key", func(t *testing.T) {
		...
		auditLogger := auditlogger.NewAuditLoggerForTesting()
		resolver := graph.
			NewResolver(nil, nil, nil, nil, nil, db, tenantDomain, usersyncTrigger, auditLogger, nil, nil, log, nil, nil, nil, nil, nil, nil, nil, auditer).
			Mutation()
