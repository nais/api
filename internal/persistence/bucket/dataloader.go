...
type loaders struct {
	k8sClient     *client
	datasetLoader *dataloadgen.Loader[resourceIdentifier, *Bucket]
}
...
func (l dataloader) list(ctx context.Context, ids []resourceIdentifier) ([]*Bucket, []error) {
	makeKey := func(obj *Bucket) resourceIdentifier {
	...
	return loaderv1.LoadModels(ctx, ids, l.k8sClient.getBuckets, func(d *Bucket) *Bucket { return d }, makeKey)
}
