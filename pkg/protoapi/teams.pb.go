...
var file_teams_proto_rawDesc = []byte{
	...
	0x0b, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x34, 0x0a, 0x04,
	...
	0x73, 0x65, 0x22, 0x2c, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x54, 0x65, 0x61, 0x6d, 0x52, 0x65, 0x73,
	...
	0x09, 0x0a, 0x05, 0x4f, 0x57, 0x4e, 0x45, 0x52, 0x10, 0x02, 0x32, 0xa4, 0x01, 0x0a, 0x05, 0x54,
...
var file_teams_proto_depIdxs = []int32{
	...
	9,  // 2: ListTeamsResponse.page_info:type_name -> PageInfo
	8,  // 3: ListTeamMembersResponse.nodes:type_name -> TeamMember
	9,  // 4: ListTeamMembersResponse.page_info:type_name -> PageInfo
	10, // 5: TeamMember.user:type_name -> User
	0,  // 6: TeamMember.role:type_name -> TeamMemberRole
	3,  // 7: Teams.Get:input_type -> GetTeamRequest
	4,  // 8: Teams.List:input_type -> ListTeamsRequest
	6,  // 9: Teams.Members:input_type -> ListTeamMembersRequest
	2,  // 10: Teams.Get:output_type -> GetTeamResponse
	5,  // 11: Teams.List:output_type -> ListTeamsResponse
	7,  // 12: Teams.Members:output_type -> ListTeamMembersResponse
