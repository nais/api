...
// IsRepositoryAuthorized provides a mock function with given fields: _a0, _a1
func (_m *MockTeamsServer) IsRepositoryAuthorized(_a0 context.Context, _a1 *IsRepositoryAuthorizedRequest) (*IsRepositoryAuthorizedResponse, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *IsRepositoryAuthorizedRequest) (*IsRepositoryAuthorizedResponse, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *IsRepositoryAuthorizedRequest) *IsRepositoryAuthorizedResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *IsRepositoryAuthorizedRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
//   - _a0 context.Context
//   - _a1 *IsRepositoryAuthorizedRequest
func (_e *MockTeamsServer_Expecter) IsRepositoryAuthorized(_a0 interface{}, _a1 interface{}) *MockTeamsServer_IsRepositoryAuthorized_Call {
	return &MockTeamsServer_IsRepositoryAuthorized_Call{Call: _e.mock.On("IsRepositoryAuthorized", _a0, _a1)}
}

func (_c *MockTeamsServer_IsRepositoryAuthorized_Call) Run(run func(_a0 context.Context, _a1 *IsRepositoryAuthorizedRequest)) *MockTeamsServer_IsRepositoryAuthorized_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*IsRepositoryAuthorizedRequest))
	})
	return _c
}

func (_c *MockTeamsServer_IsRepositoryAuthorized_Call) Return(_a0 *IsRepositoryAuthorizedResponse, _a1 error) *MockTeamsServer_IsRepositoryAuthorized_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockTeamsServer_IsRepositoryAuthorized_Call) RunAndReturn(run func(context.Context, *IsRepositoryAuthorizedRequest) (*IsRepositoryAuthorizedResponse, error)) *MockTeamsServer_IsRepositoryAuthorized_Call {
	_c.Call.Return(run)
	return _c
}
